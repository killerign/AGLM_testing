...
exports.destroy = (req,res,next) => {
    lecture.findOneAndDelete({"name": req.body.name})
    .then(result => {
        next();
        res.sendStatus(200);
    })
...
exports.destroyfile = (req,res,next) => {
    lecture.findOneAndUpdate({lecture_id: req.body.id},{$pull : {"repository.0": req.body.url}})
    .then(result => {
        next();
        res.sendStatus(200);
    })
